      ...
      return (
            <>
                  <div className="sm:h-full">
                        ...
                        <form onSubmit={e => { buttonActive && handleSendInfoes(e, sendEmail) }} onChange={handleCheckInfo} className="w-9/10 lg:w-7/10 m-auto sm:h-full relative" autoComplete="off">
                              <h1 className="text-2xl sm:text-3xl text-white my-4 font-extrabold font-[Tagesschrift,system-ui]">Create your account</h1>
                              <div className="mt-10">
                                    <Input placeholder={'name'} name={'name'} min={2} className='my-4! lg:my-7!' />
                                    <Input placeholder={'email'} name={'email'} type="email" className='my-4! lg:my-7!' />
                              ...
                              <div className="sm:grid grid-cols-[2fr_1fr_1fr] gap-2">
                              ...
                              <Button className={'sm:absolute sm:bottom-17 sm:left-1/2 sm:-translate-x-1/2'} submit={true} loading={loading} disabled={!buttonActive}>Next</Button >
                        </form >
                  </div >
